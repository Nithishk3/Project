 ...
 class Product {
    ...
    void pmainpage(int k){
        ...
        while(true){
            ...
            System.out.println("WELCOME "+Merchant.ls.get(k).username);
            System.out.print("""
                                1.Add Product
                                2.Remove product
                                3.Update Product
    ...
    void addpro(int k){
        ...
        pl1.add(new Product(a,++q,(Merchant.ls.get(k).id),d,e,f,g));
        System.out.print("\033[H\033[2J");
    ...
    void Showpro(int k){
        ...
        String a=sc.nextLine();
        if(Merchant.ls.get(k).id.equals(a)){
