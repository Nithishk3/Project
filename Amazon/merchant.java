...
class Merchant {
    ...
    int pin;
    String status;
    Merchant(String a,String b,int c,String d){
        this.username=a;
        this.id=b;
        this.pin=c;
        this.status=d;
    ...
    Merchant(){}
    static int b=101;
    static List<Merchant>ls=new ArrayList<>();
    Scanner sc;
    void mainpage(){
        ls.add(new Merchant("nithish","m100",1234,"ok"));
    ...
    int findapp(int v){
        ...
        else if(ls.get(v).status.equals("Rejected")){
            return 2;
        }
        return 3;
    }
